...
var list = ['\r\n新光三越', '\r\n明耀', '\r\n南紡', '\r\n林百貨', '\r\n三井', '\r\n美麗華'];
var sentence = ['我要去逛新光三越', '我要去明耀百貨', '我要去南紡百貨', '我要去林百貨', '我要去三井outlet', '我要去美麗華百貨'];
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '新光三越百貨 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '明耀百貨 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '南紡百貨 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '林百貨 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '三井OUTLET 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '美麗華百貨 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
