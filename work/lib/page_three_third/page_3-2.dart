...
class Page_3_2 extends StatefulWidget {
  const Page_3_2({Key? key}) : super(key: key);

  @override
  State<Page_3_2> createState() => _Page_3_2();
}

class _Page_3_2 extends State<Page_3_2> {
...
class Page_3_2_Setting extends StatelessWidget {
  final myController = [
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '白沙灣 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '外澳 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '觀汐平台 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '西子灣 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '七星潭 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '金樽 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
