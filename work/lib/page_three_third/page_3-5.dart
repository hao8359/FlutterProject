...
var list = ['\r\n全聯', '\r\n主婦聯盟', '\r\n家樂福', '\r\n好市多', '\r\n頂好', '\r\n大潤發'];
var sentence = ['我要去全聯', '我要去主婦聯盟', '我要去家樂福', '我要去好市多', '我要去頂好', '我要去大潤發'];
var picture = ['assets/supermarket1.png','assets/supermarket2.png','assets/supermarket3.png','assets/supermarket4.png','assets/supermarket5.png',
  'assets/supermarket6.png','assets/supermarket7.png','assets/supermarket8.png'];

var box_color=Colors.orange;
class Page_3_5 extends StatefulWidget {
  const Page_3_5({Key? key}) : super(key: key);

  @override
  State<Page_3_5> createState() => _Page_3_5();
}

class _Page_3_5 extends State<Page_3_5> {
...
class Page_3_5_Setting extends StatelessWidget {
  final myController = [
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '全聯 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '主婦聯盟 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '家樂福 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '好市多 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '頂好 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '大潤發 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
