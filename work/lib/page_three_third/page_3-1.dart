...
var list = ['\r\n台北榮總', '\r\n新竹國泰', '\r\n台中榮總', '\r\n台南成大', '\r\n高雄旗津', '\r\n花蓮慈濟'];
var sentence = ['我要去台北榮總醫院 ', '我要去新竹國泰醫院', '我要去台中榮總醫院 ', '我要去台南成大醫院', '我要去高雄旗津醫院 ', '我要去花蓮慈濟醫院'];
...
class Page_3_1 extends StatefulWidget {
  const Page_3_1({Key? key}) : super(key: key);

  @override
  State<Page_3_1> createState() => _Page_3_1();
}

class _Page_3_1 extends State<Page_3_1> {
...
class Page_3_1_Setting extends StatelessWidget {
  final myController = [
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '台北榮總 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '新竹國泰 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '台中榮總 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '台南成大 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '高雄旗津 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
                  ...
                  child: Column(
                    children: <Widget>[
                      TextField(
                        ...
                        decoration: InputDecoration(hintText: '花蓮慈濟 欄位請輸入...'),
                      ),
                      RaisedButton(
                        child: Text('儲存內容'),
                        onPressed: () {
