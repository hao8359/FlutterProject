...
var list = ['\r\n鼓山', '\r\n陽明', '\r\n龍磐草原', '\r\n玉山', '\r\n合歡', '\r\n阿里'];
var sentence = ['我要去鼓山', '我要去陽明山', '我要去龍磐草原', '我要去玉山', '我要去合歡', '我要去阿里山'];
var picture = ['assets/mountain1.png','assets/mountain2.png','assets/mountain3.png','assets/mountain4.png','assets/mountain5.png',
  'assets/mountain6.png','assets/mountain7.png','assets/mountain8.png'];


var box_color=Colors.orange;
class Page_3_3 extends StatefulWidget {
  const Page_3_3({Key? key}) : super(key: key);

  @override
  State<Page_3_3> createState() => _Page_3_3();
}

class _Page_3_3 extends State<Page_3_3> {
...
class Page_3_3_Setting extends StatelessWidget {
  final myController = [
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '鼓山 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '陽明山 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '龍磐草原 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '玉山 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '合歡山 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '阿里山 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
