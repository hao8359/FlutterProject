...
var list = ['\r\n觀霧山莊', '\r\n落羽松秘境', '\r\n麗寶樂園', '\r\n安平', '\r\n卡悠峯瀑布', '\r\n南田'];
var sentence = ['我要去觀霧山莊', '我要去落羽松秘境', '我要去麗寶樂園', '我要去安平', '我要去卡悠峯瀑布', '我要去南田'];
var picture = ['assets/travel1.png','assets/travel2.png','assets/travel3.png','assets/travel4.png','assets/travel5.png',
  'assets/travel6.png','assets/travel7.png','assets/travel8.png'];

var box_color=Colors.orange;
class Page_3_7 extends StatefulWidget {
  const Page_3_7({Key? key}) : super(key: key);

  @override
  State<Page_3_7> createState() => _Page_3_7();
}

class _Page_3_7 extends State<Page_3_7> {
...
class Page_3_7_Setting extends StatelessWidget {
  final myController = [
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '觀霧山莊 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '落雨松秘境 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '麗寶樂園 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '安平 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '卡悠峯瀑布 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '南田 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
