...
var list = ['\r\n腳踏車', '\r\n一起去', '\r\n散步', '\r\n出門', '\r\n爬山', '\r\n公園','\r\n操場','\r\n家附近','\r\n打籃球','\r\n打羽球'];
var sentence = ['我要去騎腳踏車', '你要一起去嗎', '要不要出門散步', '要不要出門兜風', '要不要去爬山', '要不要去公園走走', '要不要去操場慢跑','要不要在家附近走走', '要不要' '要不要去打籃球', '要不要去打羽球'];
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '腳踏車 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '一起去 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '散步 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '出門 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '爬山 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '公園 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '操場 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '家附近 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '打籃球 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '打羽球 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
