...
var list = ['\r\n去哪', '\r\n怎麼去', '\r\n我載你', '\r\n開車', '\r\n摩托車', '\r\n公車','\r\n計程車','\r\n火車','\r\n回來','\r\n出發'];
var sentence = ['你要去哪裡', '你要怎麼去', '我載你去', '我開車', '我騎摩托車', '我搭公車', '我搭計程車', '我搭火車', '什麼時候回來', '什麼時候出發'];
var picture = ['assets/where-transformed.png','assets/question-transformed.png','assets/car-transformed.png','assets/car-transformed.png','assets/scooter-transformed.png',
  'assets/bus-transformed.png','assets/taxi-transformed.png','assets/train-transformed.png','assets/home.png','assets/car-transformed.png','assets/education.png','assets/education.png'];
var box_color=Colors.lightGreen;
class Page_2_6 extends StatefulWidget {
  const Page_2_6({Key? key}) : super(key: key);

  @override
  State<Page_2_6> createState() => _Page_2_6();
}

class _Page_2_6 extends State<Page_2_6> {
...
class Page_2_6_Setting extends StatelessWidget {
  final myController = [
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '去哪 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '怎麼去 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '我載你 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '開車 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '摩托車 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '公車 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '計程車 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '火車 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '回來 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
                    ...
                    child: Column(
                      children: <Widget>[
                        TextField(
                          ...
                          decoration: InputDecoration(hintText: '出發 欄位請輸入...'),
                        ),
                        RaisedButton(
                          child: Text('儲存內容'),
                          onPressed: () {
