...
class Page_1_5_2 extends StatefulWidget {
  const Page_1_5_2({Key? key}) : super(key: key);

  @override
  State<Page_1_5_2> createState() => _Page_1_5_2();
}

class _Page_1_5_2 extends State<Page_1_5_2> {
...
class Page_1_5_2_Setting extends StatelessWidget {
  final myController = [
