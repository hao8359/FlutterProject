import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-1.dart';
import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-2.dart';
import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-3.dart';
import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-4.dart';
import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-5.dart';
import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-6.dart';
import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-7.dart';
import 'package:final_try/page_one_2nd/page_1-4_3rd/page1-4-8.dart';
...
var list = ['\r\n溜狗', '\r\n腳踏車', '\r\n高鐵', '\r\n捷運', '\r\n公車', '\r\n跑步', '\r\n摩托車', '\r\n計程車'];
var sentence = ['', '', '', '', '', '','', ''];
var picture = ['assets/walk2.png','assets/bike.png','assets/express.png','assets/metro.png','assets/bus.png',
  'assets/run.png','assets/motorbike2.png','assets/taxi.png'];
...
class Page_1_4 extends StatefulWidget {
  const Page_1_4({Key? key}) : super(key: key);

  @override
  State<Page_1_4> createState() => _Page_1_4();
}

class _Page_1_4 extends State<Page_1_4> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: ListBody(
          children: [
            Expanded(
              child: function(picture[0], list[0], sentence[0],Page_1_4_1(),picture[1], list[1], sentence[1],Page_1_4_2()),
            ),
            Expanded(
              child: function(picture[2], list[2], sentence[2],Page_1_4_3(),picture[3], list[3], sentence[3],Page_1_4_4()),
            ),
            Expanded(
              child: function(picture[4], list[4], sentence[4],Page_1_4_5(),picture[5], list[5], sentence[5],Page_1_4_6()),
            ),
            Expanded(
              child: function(picture[6], list[6], sentence[6],Page_1_4_7(),picture[7], list[7], sentence[7],Page_1_4_8()),
            ),
            Padding(
...
class Page_1_4_Setting extends StatelessWidget {
  final myController = [
