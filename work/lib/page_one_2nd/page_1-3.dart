...
var list = ['\r\n臥室', '\r\n陽台', '\r\n玄關', '\r\n花園', '\r\n客廳', '\r\n廁所', '\r\n公設', '\r\n廚房'];
var sentence = ['', '', '', '', '', '','', ''];
var picture = ['assets/bedroom.png','assets/balcony.png','assets/entrance.png','assets/garden.png','assets/livingroom.png',
  'assets/toilet.png','assets/publicfacility.png','assets/kitchen.png'];
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: ListBody(
          children: [
            Expanded(
              child: function(picture[0], list[0], sentence[0],Page_1_3_1(),picture[1], list[1], sentence[1],Page_1_3_2()),
            ),
            Expanded(
              child: function(picture[2], list[2], sentence[2],Page_1_3_3(),picture[3], list[3], sentence[3],Page_1_3_4()),
            ),
            Expanded(
              child: function(picture[4], list[4], sentence[4],Page_1_3_5(),picture[5], list[5], sentence[5],Page_1_3_6()),
            ),
            Expanded(
              child: function(picture[6], list[6], sentence[6],Page_1_3_7(),picture[7], list[7], sentence[7],Page_1_3_8()),
            ),
            Padding(
