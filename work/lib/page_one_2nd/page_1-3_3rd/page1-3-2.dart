...
var list = ['\r\n種花', '\r\n桌子', '\r\n椅子', '\r\n清潔', '\r\n澆花', '\r\n裝飾', '\r\n雨棚', '\r\n燈'];
var sentence = ['我要去種花', '我想要擺桌子', '我想要去座椅子', '我要清理陽台', '我要去澆花', '我想要在陽台上擺放裝飾', '陽台裝雨棚或許不錯', '我想要點燈'];
var picture = ['assets/flower.png','assets/table.png','assets/chair.png','assets/clean.png','assets/shoot.png',
  'assets/accessories.png','assets/raincover.png','assets/light.png'];

class Page_1_3_2 extends StatefulWidget {
  const Page_1_3_2({Key? key}) : super(key: key);

  @override
  State<Page_1_3_2> createState() => _Page_1_3_2();
}

class _Page_1_3_2 extends State<Page_1_3_2> {
...
class Page_1_3_2_Setting extends StatelessWidget {
  final myController = [
