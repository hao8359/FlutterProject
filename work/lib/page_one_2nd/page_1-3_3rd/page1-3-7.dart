...
var list = ['\r\n泳池', '\r\n溫泉', '\r\n球場', '\r\n童樂', '\r\n遊戲', '\r\n復健', '\r\n管理', '\r\n健身'];
var sentence = ['我要去游泳池', '我想要去泡溫泉', '我想要去球場打球', '我想要去童樂區', '我想要去遊戲室', '我想去做復健', '我要去社區的管理室', '我想去健身房'];
var picture = ['assets/swimmingpool.png','assets/warmpool.png','assets/court.png','assets/playboi.png','assets/gameroom.png',
  'assets/recover.png','assets/manament.png','assets/gym.png'];

class Page_1_3_7 extends StatefulWidget {
  const Page_1_3_7({Key? key}) : super(key: key);

  @override
  State<Page_1_3_7> createState() => _Page_1_3_7();
}

class _Page_1_3_7 extends State<Page_1_3_7> {
...
class Page_1_3_7_Setting extends StatelessWidget {
  final myController = [
