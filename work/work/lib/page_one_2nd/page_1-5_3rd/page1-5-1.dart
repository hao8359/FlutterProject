...
class Page_1_5_1 extends StatefulWidget {
  const Page_1_5_1({Key? key}) : super(key: key);

  @override
  State<Page_1_5_1> createState() => _Page_1_5_1();
}

class _Page_1_5_1 extends State<Page_1_5_1> {
...
class Page_1_5_1_Setting extends StatelessWidget {
  final myController = [
