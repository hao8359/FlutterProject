import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-1.dart';
import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-2.dart';
import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-3.dart';
import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-4.dart';
import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-5.dart';
import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-6.dart';
import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-7.dart';
import 'package:final_try/page_one_2nd/page_1-7_3rd/page1-7-8.dart';
...
class Page_1_7 extends StatefulWidget {
  const Page_1_7({Key? key}) : super(key: key);

  @override
  State<Page_1_7> createState() => _Page_1_7();
}

class _Page_1_7 extends State<Page_1_7> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: ListBody(
          children: [
            Expanded(
              child: function(picture[0], list[0], sentence[0],Page_1_7_1(),picture[1], list[1], sentence[1],Page_1_7_2()),
            ),
            Expanded(
              child: function(picture[2], list[2], sentence[2],Page_1_7_3(),picture[3], list[3], sentence[3],Page_1_7_4()),
            ),
            Expanded(
              child: function(picture[4], list[4], sentence[4],Page_1_7_5(),picture[5], list[5], sentence[5],Page_1_7_6()),
            ),
            Expanded(
              child: function(picture[6], list[6], sentence[6],Page_1_7_7(),picture[7], list[7], sentence[7],Page_1_7_8()),
            ),
            Padding(
...
class Page_1_7_Setting extends StatelessWidget {
  final myController = [
