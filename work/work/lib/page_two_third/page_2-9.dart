...
var list = ['\r\n水煮雞胸肉', '\r\n清滷雞腿', '\r\n泰式打拋豬', '\r\n香蒜烤鯛魚', '\r\n泡菜梅花豬', '\r\n香檸烤鮭魚'];
var sentence = ['我今天想吃水煮雞胸肉', '我今天想吃清滷雞腿', '我今天想吃泰式打拋豬', '我今天想吃香蒜烤鯛魚', '我今天想吃泡菜梅花豬', '我今天想吃香檸烤鮭魚'];
var box_color=Colors.lightGreen;
class Page_2_9 extends StatefulWidget {
  const Page_2_9({Key? key}) : super(key: key);

  @override
  State<Page_2_9> createState() => _Page_2_9();
}

class _Page_2_9 extends State<Page_2_9> {
...
class Page_2_9_Setting extends StatelessWidget {
  final myController = [
